...
class AutomergerTest {
    ...
    private final Automerger automerger = new Automerger();
    ...
    @Test
    void autoMerge_ShouldNotReturnNull_WhenGivenNull() {
        // Auto-merge Concepts
        Concept result = automerger.automerge(null, null, null);
    ...
    void autoMerge_ShouldReturnExpected_WhenTargetConceptChangesNothing() {
        // Auto-merge Concepts
        Concept result = automerger.automerge(sourceConcept, targetConceptBefore, targetConceptAfter);
